...
ActiveRecord::Schema.define(version: 20151216181757) do
  ...
  add_index "bookings", ["flights_id"], name: "index_bookings_on_flights_id"
  add_index "bookings", ["passenger_id"], name: "index_bookings_on_passenger_id"
  add_index "bookings", ["passengers_id"], name: "index_bookings_on_passengers_id"
